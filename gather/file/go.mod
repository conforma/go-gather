...
require (
	github.com/enterprise-contract/go-gather/expander v0.0.0-20240605192053-1dbd1cbbfdcd
	github.com/enterprise-contract/go-gather/metadata v0.0.0-20240523073727-ba2c37023242
	github.com/enterprise-contract/go-gather/metadata/file v0.0.0-20240605192053-1dbd1cbbfdcd
