...
require (
	...
	github.com/enterprise-contract/go-gather/metadata/http v0.0.0-20240605192053-1dbd1cbbfdcd
...
require (
	...
	github.com/enterprise-contract/go-gather/saver/file v0.0.0-20240523073727-ba2c37023242 // indirect
